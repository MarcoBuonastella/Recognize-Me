...
plt.figure(3)
plt.plot(history.history['acc'], linestyle = 'solid', marker='o'  ,markersize = 4  ,linewidth = 1)
plt.ylabel('Accuracy')
plt.xlabel('Epoch')
plt.title('CNN Training Accuracy No Dropout & No Augmentation')

plt.figure(4)
plt.plot(history.history['val_acc'], linestyle = 'solid', marker='o'  ,markersize = 4  ,linewidth = 1)
plt.ylabel('Accuracy')
plt.xlabel('Epoch')
plt.title('CNN Validation Accuracy No Dropout & No Augmentation')
plt.show()
